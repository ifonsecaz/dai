        ...
        protected void ddJuegos_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (miConexion != null)
            {
                ...
                if (rd.HasRows)
                {
                    ...
                    String query = String.Format("select critica.contentido from critica where critica.claveC=(select claveC from escriben where escriben.claveU='{0}' and escriben.claveJ='{1}')", Session["claveUnica"].ToString(), claveJuego);
